       ...
       <header>
            ...
            <div id="menu">
                <ul id="menu-deroulant">
                    <li><a href="investPages/connected?page=2">Sociétés </a></li>
                    <li><a href="investPages/connected?page=3">Offres </a></li>
                    <li><a href="investPages/connected?page=4">Mes transactions </a></li>
        ...
        <section id ="forminfoste"> 
          <center>
            <form id = "formste" method="post" action="XXX"></form>
              <fieldset>
                <legend>Bienvenue sur votre espace membre !</legend>
        </section> 
        <footer>          
        </footer>   
    </body>
