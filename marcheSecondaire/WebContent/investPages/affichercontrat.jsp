               ...
               <center>
                ...
                <table class="tg">
                    ...
                    <th class="tg-7btt">Disponible(s)</th>
        				    <th class="tg-7btt">Acheter</th>
                    <th class="tg-7btt">Quantité</th>
        				  </tr>
        				  <tr>
        				    <td class="tg-0lax"></td>
        				    <td class="tg-0lax"></td>
                    ...
                    <td class="tg-0lax"></td>
                    <td class="tg-0lax"></td>
        				    <td class="tg-0lax"><input type="checkbox" name="choix1" value="1"> </td>
                    <td class="tg-0lax"><input type="text" value="0" size="3" maxlength="10" > </td>
        				  </tr>
        				</table>
                <br/><br/>
